 ...
 * @author Esteban
 */
@WebServlet(name = "ActualizarDependencia", urlPatterns = {"/ActualizarDependencia"})
public class ActualizarDependencia extends HttpServlet {
    @EJB
    private EjbPmd ejb;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ActualizarDependencia</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ActualizarDependencia at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
