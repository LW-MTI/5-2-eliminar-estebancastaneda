 ...
 * @author Esteban
 */
@WebServlet(name = "ActualizarCategoriaplan", urlPatterns = {"/ActualizarCategoriaplan"})
public class ActualizarCategoriaplan extends HttpServlet {
    @EJB
    private EjbPmd ejb;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ActualizarCategoriaplan</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ActualizarCategoriaplan at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            p.write(ejb.actualizarCategoriaplan(idcat, clavecat, nombrecat, idcatpadre, idplan, descripcat));
